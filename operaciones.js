...
function updateDetallesPersonas(
  con,
  identidad,
  nombre_asegurado,
  numero_certificado,
  ...
  const updateQuery =
    "update inconvenientes_certificados set identidad = ?,    nombre_asegurado = ?,    numero_certificado = ?,    observaciones = ?, fecha_modificacion =? where id = ?";
